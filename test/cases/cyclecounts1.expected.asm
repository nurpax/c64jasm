...
083A: 30 0E        BMI $084A                      ; 2/3
083C: 10 0C        BPL $084A                      ; 2/3
083E: 90 0A        BCC $084A                      ; 2/3
0840: B0 08        BCS $084A                      ; 2/3
0842: F0 06        BEQ $084A                      ; 2/3
0844: D0 04        BNE $084A                      ; 2/3
0846: 50 02        BVC $084A                      ; 2/3
0848: 70 00        BVS $084A                      ; 2/3
084A: 00           BRK                            ; 7
084B: 18           CLC                            ; 2
084C: D8           CLD                            ; 2
084D: 58           CLI                            ; 2
...
0949: 9D 00 44     STA $4400,X                    ; 5
094C: 99 00 44     STA $4400,Y                    ; 5
094F: 81 44        STA ($44,X)                    ; 6
0951: 91 44        STA ($44),Y                    ; 6
0953: EA           NOP                            ; 2
0954: AA           TAX                            ; 2
0955: 8A           TXA                            ; 2
0956: A8           TAY                            ; 2
